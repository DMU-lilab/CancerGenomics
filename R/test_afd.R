...
test_afd <- function(FREQ_1.x, FREQ_1.y){
  ...
  arg_table <- create_argtable(power = seq(1, 5, by = 1), density = c(T), density_method = c("xdensity", "kde2d"), n = 2^(7:9),filterAF = seq(0, 1, by = 0.2), filterDEV = c(seq(0,0.5),seq(1,20, by = 5)))
